...
CREATE TABLE "companies" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "rif" varchar(255), "phone" varchar(255), "fax" varchar(255), "address" varchar(255), "created_at" datetime, "updated_at" datetime, "ip_address" varchar(255));
...
CREATE TABLE "orders" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "date" datetime, "recipient" varchar(255), "longitude" float, "latitude" float, "status" integer, "collectiondate" datetime, "deliverydate" datetime, "address_id" integer, "client_id" integer, "creditcard_id" integer, "created_at" datetime, "updated_at" datetime, "route_id" integer, "street" varchar(255), "name" varchar(255), "number" varchar(255), "zone" varchar(255), "city" varchar(255), "country" varchar(255), "zip" integer, "order_type" integer, "extra" float, "company_id" integer, "external" integer);
...
INSERT INTO schema_migrations (version) VALUES ('20110611225431');

INSERT INTO schema_migrations (version) VALUES ('20110615204117');